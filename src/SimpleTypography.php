...
namespace nguyenanhung\Libraries\Typography;
...
class SimpleTypography
{
    ...
    public function auto_typography(string $str, bool $reduce_linebreaks = false): string
    {
        ...
        $html_comments = array();
        if (mb_strpos($str, '<!--') !== false && preg_match_all('#(<!\-\-.*?\-\->)#s', $str, $matches)) {
